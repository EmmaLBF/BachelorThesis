...
Node* v32(void* env, void* v11_raw) {
  ...
  return ((isEmpty(((Env_v32*)env)->v9)) ? (((Env_v32*)env)->v8) : ((Node*)apply((Closure*)apply((Closure*)c29, box_int(*(int*)(head(((Env_v32*)env)->v9)))), (void*)(tail(((Env_v32*)env)->v9)))));
}
...
Node* v36(void* env, void* v9_raw) {
  ...
  return ((isEmpty(((Env_v36*)env)->v8)) ? (v9) : ((Node*)apply((Closure*)apply((Closure*)c33, box_int(*(int*)(head(((Env_v36*)env)->v8)))), (void*)(tail(((Env_v36*)env)->v8)))));
}
...
Pair* v51(void* env, void* v22_raw) {
  ...
  return (Pair*)apply((Closure*)c46, (void*)(v17(mk_pair(box_int((((Env_v51*)env)->v19 - 1)), v22))));
}
...
Node* v84(void* env, void* v3_raw) {
  ...
  return ((isEmpty(v3)) ? (cons(box_int(((Env_v84*)env)->v2), NULL)) : ((Node*)apply((Closure*)apply((Closure*)c81, box_int(*(int*)(head(v3)))), (void*)(tail(v3)))));
}
