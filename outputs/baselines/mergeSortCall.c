...
Node* v28(void* env28, void* v13_raw) {
  ...
  if ((((Env_v28*)env28)->v10 < ((Env_v28*)env28)->v12)) {
    return cons(box_int(((Env_v28*)env28)->v10), (Node*)apply((Closure*)v7(((Env_v28*)env28)->v11), (void*)(((Env_v28*)env28)->v9)));
  } else {
    return cons(box_int(((Env_v28*)env28)->v12), (Node*)apply((Closure*)v7(v13), (void*)(((Env_v28*)env28)->v8)));
  }
}
...
Node* v32(void* env32, void* v11_raw) {
  ...
  return ((isEmpty(((Env_v32*)env32)->v9)) ? (((Env_v32*)env32)->v8) : ((Node*)apply((Closure*)apply((Closure*)c29, box_int(*(int*)(head(((Env_v32*)env32)->v9)))), (void*)(tail(((Env_v32*)env32)->v9)))));
}
...
Node* v36(void* env36, void* v9_raw) {
  ...
  return ((isEmpty(((Env_v36*)env36)->v8)) ? (v9) : ((Node*)apply((Closure*)apply((Closure*)c33, box_int(*(int*)(head(((Env_v36*)env36)->v8)))), (void*)(tail(((Env_v36*)env36)->v8)))));
}
...
Pair* v51(void* env51, void* v22_raw) {
  ...
  return (Pair*)apply((Closure*)c46, (void*)(v17(mk_pair(box_int((((Env_v51*)env51)->v19 - 1)), v22))));
}
...
Pair* v55(void* env55, void* v20_raw) {
  ...
  if ((((Env_v55*)env55)->v19 == 0)) {
    ...
    return ((isEmpty(v20)) ? (mk_pair(NULL, NULL)) : ((Pair*)apply((Closure*)apply((Closure*)c52, box_int(*(int*)(head(v20)))), (void*)(tail(v20)))));
  }
}
...
Pair* v58(void* env58, void* v19_raw) {
  ...
  return (Pair*)apply((Closure*)c55, (void*)((Node*)snd(((Env_v58*)env58)->v18)));
}
...
Node* v84(void* env84, void* v3_raw) {
  ...
  return ((isEmpty(v3)) ? (cons(box_int(((Env_v84*)env84)->v2), NULL)) : ((Node*)apply((Closure*)apply((Closure*)c81, box_int(*(int*)(head(v3)))), (void*)(tail(v3)))));
}
