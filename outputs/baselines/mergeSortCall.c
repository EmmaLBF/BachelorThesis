...
Node* v33(void* env, void* v10_raw, void* v11_raw) {
  ...
  return (isEmpty(((Env_v33*)env)->v9)) ? (((Env_v33*)env)->v8) : ((Node*)((Closure*)c)->fn(((Closure*)c)->env, box_int(*(int*)(head(((Env_v33*)env)->v9))), (void*)(tail(((Env_v33*)env)->v9))));
}
...
Node* v7(Node* v8, Node* v9) {
  ...
  return (isEmpty(v8)) ? (v9) : ((Node*)((Closure*)c)->fn(((Closure*)c)->env, box_int(*(int*)(head(v8))), (void*)(tail(v8))));
}
...
Pair* v52(void* env, void* v21_raw, void* v22_raw) {
  ...
  return (Pair*)apply((Closure*)c, (void*)(v17(mk_pair(box_int((((Env_v52*)env)->v19 - 1)), v22))));
}
