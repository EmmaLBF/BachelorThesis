...
// main
int main(void) {
  Node *list = cons(box_int(758), cons(box_int(720), cons(box_int(100), cons(box_int(835), cons(box_int(561), cons(box_int(332), cons(box_int(966), cons(box_int(448), cons(box_int(665), cons(box_int(774), cons(box_int(117), cons(box_int(424), cons(box_int(448), cons(box_int(481), cons(box_int(952), cons(box_int(769), cons(box_int(566), cons(box_int(516), cons(box_int(527), cons(box_int(587), cons(box_int(432), cons(box_int(21), cons(box_int(499), cons(box_int(511), cons(box_int(96), cons(box_int(27), cons(box_int(490), cons(box_int(685), cons(box_int(144), cons(box_int(64), cons(box_int(396), cons(box_int(5), cons(box_int(673), cons(box_int(423), cons(box_int(588), cons(box_int(403), cons(box_int(935), cons(box_int(416), cons(box_int(123), cons(box_int(892), cons(box_int(300), cons(box_int(737), cons(box_int(790), cons(box_int(563), cons(box_int(558), cons(box_int(234), cons(box_int(469), cons(box_int(508), cons(box_int(595), cons(box_int(807), cons(box_int(254), cons(box_int(389), cons(box_int(946), cons(box_int(430), cons(box_int(228), cons(box_int(329), cons(box_int(565), cons(box_int(395), cons(box_int(688), cons(box_int(215), cons(box_int(894), cons(box_int(411), cons(box_int(36), cons(box_int(717), cons(box_int(430), cons(box_int(767), cons(box_int(345), cons(box_int(841), cons(box_int(449), cons(box_int(999), cons(box_int(508), cons(box_int(435), cons(box_int(212), cons(box_int(150), cons(box_int(170), cons(box_int(235), cons(box_int(373), cons(box_int(144), cons(box_int(633), cons(box_int(814), cons(box_int(237), cons(box_int(706), cons(box_int(100), cons(box_int(494), cons(box_int(862), cons(box_int(371), cons(box_int(394), cons(box_int(76), cons(box_int(680), cons(box_int(701), cons(box_int(843), cons(box_int(802), cons(box_int(162), cons(box_int(821), cons(box_int(847), cons(box_int(821), cons(box_int(228), cons(box_int(157), cons(box_int(432), cons(box_int(473), NULL))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
  printList(v0(list));
  return 0;
}
