...
Node* v9(void* env, void* v2_raw) {
  ...
  return (isEmpty(v8)) ? (NULL) : ((Node*)apply((Closure*)apply((Closure*)c, box_int(*(int*)(head(v8)))), (void*)(tail(v8))));
}
...
int main(void) {
  Closure* v11 = v0(v10);
  printList((Node*)apply((Closure*)v11, (void*)(cons(box_int(1), cons(box_int(2), cons(box_int(3), NULL))))));
  return 0;
}
