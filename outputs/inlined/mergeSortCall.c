...
Node* v7(Node* v8, Node* v9) {
  ...
  if (isEmpty(v8)) {
    ...
    return (Node*)((isEmpty(((Env_v33*)env33)->v9)) ? (((Env_v33*)env33)->v8) : ((Node*)v29(env29, box_int(*(int*)(head(((Env_v33*)env33)->v9))), (void*)(tail(((Env_v33*)env33)->v9)))));
  }
}
...
Pair* v17(Pair* v18) {
  ...
  env55->v19 = v19;
  return (Pair*)(Pair*)v55(env55, (void*)((Node*)snd(((Env_v58*)env58)->v18)));
}
...
Node* v0(Node* v1) {
  if (isEmpty(v1)) {
    ...
    if (isEmpty(v3)) {
      ...
      int v4 = *(int*)(head(v3));
      Node* v5 = tail(v3);
      return (Node*)v45(v75(cons(box_int(((Env_v81*)env81)->v2), cons(box_int(v4), v5))));
    }
  }
}
