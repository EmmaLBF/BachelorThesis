...
Node* v29(void* env, void* v12_raw, void* v13_raw) {
  ...
  if (((Env_v29*)env)->v10 < v12) {
    return cons(box_int(((Env_v29*)env)->v10), (Node*)((Closure*)v7(((Env_v29*)env)->v11))->fn(((Closure*)v7(((Env_v29*)env)->v11))->env, (void*)(((Env_v29*)env)->v9)));
  } else {
    return cons(box_int(v12), (Node*)((Closure*)v7(v13))->fn(((Closure*)v7(v13))->env, (void*)(((Env_v29*)env)->v8)));
  }
}
...
Node* v34(Pair* v6) {
  ...
  return (Node*)(Closure*)v33->fn((Closure*)v33->env, (void*)(v0((Node*)snd(v6))));
}
...
Pair* v37(void* env, void* v21_raw, void* v22_raw) {
  ...
  return (Pair*)(Closure*)c->fn((Closure*)c->env, (void*)(v17(mk_pair(box_int((((Env_v37*)env)->v19 - 1)), v22))));
}
...
Pair* v39(void* env, void* v19_raw) {
  ...
  return (Pair*)(Closure*)c->fn((Closure*)c->env, (void*)((Node*)snd(((Env_v39*)env)->v18)));
}
...
Pair* v17(Pair* v18) {
  ...
  return (Pair*)(Closure*)c->fn((Closure*)c->env, box_int(*(int*)fst(v18)));
}
...
Pair* v41(void* env, void* v15_raw) {
  ...
  return (Pair*)(Closure*)c->fn((Closure*)c->env, box_int((v15 / 2)));
}
...
Pair* v45(Node* v14) {
  ...
  return (Pair*)(Closure*)c->fn((Closure*)c->env, box_int(v44));
}
