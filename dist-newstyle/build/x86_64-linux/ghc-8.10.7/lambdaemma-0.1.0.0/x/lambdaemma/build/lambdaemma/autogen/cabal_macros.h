...
/* package lambdaemma-0.1.0.0 */
#ifndef VERSION_lambdaemma
#define VERSION_lambdaemma "0.1.0.0"
#endif /* VERSION_lambdaemma */
#ifndef MIN_VERSION_lambdaemma
#define MIN_VERSION_lambdaemma(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lambdaemma */
...
#define CURRENT_COMPONENT_ID "lambdaemma-0.1.0.0-inplace-lambdaemma"
